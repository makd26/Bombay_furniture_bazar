...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="navbar-header"><a class="navbar-brand" href="adminorders.php">Check Orders</a></div>
  ...
  <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
    <span class="navbar-toggler-icon"></span>
              ...
              <button class="button3" style="float: right; position: relative; right: 50px; font-family: verdana;" type="button"><a href="Addproducts.php">New Product</a></button> <br><br> 
              <button class="button3" style="float: right; position: relative; right: 50px; font-family: verdana;" type="button"><a href="adminlogout.php">Log Out</a></button> <br><br>
<div class="container">
  ...
  if(mysqli_num_rows($result)):
    while ($product=mysqli_fetch_assoc($result)) :
      ...
      <!--      <input type="submit" name="add_to_cart" class="btn btn-info"  value="Add to cart"> -->
          <input type="button" style=" background-color: red;" onClick="deleteme(<?php echo $product["id"]; ?>)" name="Delete" value="Delete">            
          </div>
...
<?php
  ...
  echo "You dont have access rights";
}
